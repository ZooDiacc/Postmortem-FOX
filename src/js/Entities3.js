...
let obstacles = [
  { xStart: 380, yStart: 260, xEnd: 560, yEnd: 400 },
  { xStart: 530, yStart: 230, xEnd: 690, yEnd: 320 },
  { xStart: 180, yStart: 510, xEnd: 370, yEnd: 620 }
];
...
Player = function() {
  var self = Actor("player", "myId", 790, 450, 50, 70, Img.player, 10, 1);
  ...
  self.updatePosition = function() {
    ...
    if (self.pressingRight && (self.x < 745 || (self.y > 395 && self.y < 465)))
      newX += 10;

    if (self.pressingLeft && self.x > 105) newX -= 10;
    if (self.pressingDown && (self.y < 685 || (self.x > 380 && self.x < 430)))
      newY += 10;
    if (self.pressingUp && self.y > 75) newY -= 10;
...
Enemy.randomlyGenerate = function() {
  ...
  var width = 64;
  var id = Math.random();
  if (Math.random() < 0.5) Enemy(id, x, y, 100, 100, Img.bat, 5, 1);
...
Maps.current = Maps("field", "../img/salle3.png", 1280, 960);
